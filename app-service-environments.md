...
* When to use ASE (v2) - https://blog.mexia.com.au/when-to-use-an-app-service-environment-v2, https://platform.deloitte.com.au/articles/when-to-use-an-app-service-environment-v2 
